            ...
            <div class="col-md-8 mid-right">
                ...
                <div class="row-fluid mid-right-down">
                    <div class="col-md-12 mid-r-down">
                         <h3>违纪作弊情况登记</h3>
                         <form action="<c:url value='/score/punishment' />" method="post">
                            <p class="cdl2">请输入学号：</p>
                            <input class="input-medium search-query cdl2" type="text" name="studentId" value="${studentId}"/> <button type="submit" class="btn" name="action" value="search">查找</button>
                            <div margin-top="100px">
                                <label>学号：${studentId}</label>
                                <label>姓名：${stuName}</label><br />
                                <!-- <label class="control-label" for="inputKaodian">考点：</label>
                                <input name="siteId" type="text" /><br /> -->
                                <label class="control-label" for="inputRule">违纪情况：</label>
                                <textarea name="punishDetail"></textarea>
                            </div>
                            <button type="submit" class="cdl3" name="action" value="submit">提交</button>
                        </form>
                    </div>
                </div>
            </div>
