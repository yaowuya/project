...
<body>
                ...
                <nav class="navbar vavbar-deafault pull-right" role="navigation">
                    <div class="collapse navbar-collapse" id="example-navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown"><a class="dropdown-a" href="login.html">登录</a></li>
                            <li class="dropdown"><a class="dropdown-a" href="reg.html">注册</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                ...
                <div class="login-mid-right">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" action="<%=path %>/user/login">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                          <img id="vCode" src="<%=path %>/user/verifyCode" >
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        ...
                                        <a href="<%=path %>/regist.jsp" class="btn btn-default pull-right" role="button">注册</a>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
		function _change(){
			...
			ele.src="<%=path %>/user/verifyCode?r=" + new Date().getTime();
		}
	</script>
</body>
</html>