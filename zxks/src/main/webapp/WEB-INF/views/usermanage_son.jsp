        ...
        <div class="row-fluid middle">
            ...
            <div class="col-md-8 mid-right">
                <div class="row-fluid mid-right-up">
                    <h2><i class="fa fa-desktop color"></i> 用户管理 <small>自考管理系统</small></h2>
                </div>
                <div class="row-fluid mid-right-down">
                    <div class="exampoint-manage">
                        ...
                        <div class="row-fluid r-down-footing">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="<%=path %>/user/searchUser" method="post" role="form">
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="key" value="${key }" id="inputvalue" placeholder="输入用户邮箱、姓名、地址、电话等多种查询条件">
                                        </div>
                                        <div class="col-sm-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${page.list }" var="list">
                                                    	<tr>
                                                            ...
                                                            <td>${list.phone}</td>
                                                            <td>
                                                                <a href="<%=path %>/user/changeUser?email=${list.email}" class="btn btn-primary" style="padding:0px 33px;">
                                                                           修改
                                                                    </a>
                                                                <a href="<%=path %>/user/deleteUser?email=${list.email}" class="btn btn-default" style="padding:0px 33px;">
                                                                         删除
                                                                    </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="page-btn text-center">
                                              <ul class="pagination"> 
                                                  <c:forEach begin="1" end="${page.total }" var="p">
                                                  	<c:if test="${pageNum == p }">
                                                  		<li class="active">
                                                  			<a href="<%=path%>/user/searchUser?pageNum=${p}&key=${key}">${p }</a>
                                                  		</li>
                                                  	</c:if>
                                                      <c:if test="${pageNum != p }">
                                                  		<li>
