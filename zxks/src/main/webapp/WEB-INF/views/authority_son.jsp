                ...
                <div class="row-fluid mid-right-down">
                    <div class="exampoint-manage">
                        ...
                        <div class="row-fluid r-down-footing">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="<%=path %>/user/changeAuthority?email=${u.email }" role="form" method="post">
                                    <div class="form-group">
                                        <div class="table-responsive">
                                            ...
                                            <a type="button" class="btn btn-default pull-right" style="margin-left: 10px;" href="<%=path %>/user/userAuthority">返回</a>
