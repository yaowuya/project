                ...
                <div class="row-fluid mid-right-down">
                    <div class="exampoint-manage">
                        ...
                        <div class="row-fluid r-down-footing">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="<%=path %>/apply/searchApply" method="post" role="form">
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="key" id="firstname" placeholder="输入科目、考试地点、报考进度、有关咨询电话等多种查询条件">
                                        </div>
                                        <div class="col-sm-4">
                                                ...
                                                <tbody>
                                                   ...
                                                   <c:forEach items="${page.list }" var="list">
	                                                    <tr>
	                                                        ...
	                                                        <td>${list.siteName }</td>
	                                                        <td>${list.num }</td>
	                                                        <td>${list.siteLinkman }</td>
	                                                        <td>${list.siteLinkphone }</td>
	                                                    </tr> 
                                                   </c:forEach>  
                                        ...
                                        <div class="page-btn text-center">
                                             <ul class="pagination"> 
                                                 <c:forEach begin="1" end="${page.total }" var="p">
                                                 	<c:if test="${pageNum == p }">
                                                 		<li class="active">
                                                 			<a href="<%=path%>/apply/searchApply?pageNum=${p}&key=${key}">${p }</a>
                                                 		</li>
                                                 	</c:if>
                                                     <c:if test="${pageNum != p }">
                                                 		<li>
