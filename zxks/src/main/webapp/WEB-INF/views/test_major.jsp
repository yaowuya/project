...
<body>
                            ...
                            <div class="row-fluid r-down-footing">
                                <div class="col-md-12">
                                    <div class="start-exampoint">
                                        <form class="form-horizontal" action="<%=path %>/siteMajor/searchMajor" method="post" role="form">
                                            <div class="form-group">
                                                <div class="col-sm-8">
                                                    <input type="text" name="key" class="form-control" id="inputvalue" placeholder="输入考点ID、考试名称、考点地址等多种查询条件">
                                                </div>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-hover table-condensed">
                                                        <caption class="text-center">考点专业信息</caption>
                                                        <thead>
                                                            <tr>
                                                                <th>考点ID</th>
                                                                <th>考点名称</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${page.list }" var="site">
	                                                            <tr>
	                                                                ...
	                                                                <td>${site.major_info.majorName }</td>
	                                                                <td>
	                                                                    <a type="button" href="<%=path %>/siteMajor/turnToChangeSiteMajor?siteId=${site.siteId }&majorId=${site.major_info.majorId }" name="" class="btn btn-primary" style="padding:0px 33px;">修改</a>
	                                                                </td>
	                                                            </tr>
                                                            </c:forEach>
                                                        </tbody>
                                                ...
                                                <div class="page-btn text-center">
                                                    <ul class="pagination"> 
                                                        <c:forEach begin="1" end="${page.total }" var="p">
                                                        	<c:if test="${pageNum == p }">
                                                        		<li class="active">
                                                        			<a href="<%=path%>/siteMajor/searchMajor?pageNum=${p}&key=${key}">${p }</a>
                                                        		</li>
                                                        	</c:if>
                                                            <c:if test="${pageNum != p }">
                                                        		<li>
    ...
    <script type="text/javascript" src="<%=path %>/js/test-major.js"></script>
