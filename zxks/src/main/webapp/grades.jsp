            ...
            <div class="col-md-8 mid-right">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="xiugai">
                        ...
                        <form action="<c:url value='/score/alterGrade' />" method="post">
                           <div class="cdl4">
                            <p class="cdl2">请输入查询条件：</p>
                            <input class="input-medium search-query cdl2" type="text" name="studentId" value="${alterStudentId}"/> <button type="submit" class="btn" name="alterAction" value="search">查找</button>
                           </div>      
                        <div class="cdl4">
                        <table class="table table-bordered">
                        <thead>
                              ...
                              <tr>
                                ...
                                <th><input name="alterExamGrade" value="${alterExamApply}"/></th>
                        ...
                        <button type="submit" class="cdl3" name="alterAction" value="alter">修改</button>
                        </form>
                    </div>
                </div>
