$(function(event) {
    //左边导航栏打开状态设置
    $(".mid-left .nav .mid-left-li00007").addClass("open");
    $(".mid-left .nav .mid-left-li00007").children('ul').slideDown();

    //左边导航栏切换右边
    var apage = $(".mid-left .nav .mid-left-li00007").find("a");
    ...
    //考点管理模块
    $(".r-down-footing .start-exampoint").show().siblings('div').hide();
