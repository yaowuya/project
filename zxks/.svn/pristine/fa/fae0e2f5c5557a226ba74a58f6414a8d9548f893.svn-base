...
<body>
                        ...
                        <div class="exampoint-manage">
                            ...
                            <div class="row-fluid r-down-mid">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a class="add-exampoint" href="javascript:void;">已报名的考试</a></li>
                                    <li><a class="start-exampoint" href="javascript:void;">报名考试</a></li>
                                </ul>
                                <hr>
                            </div>
                            <div class="row-fluid r-down-footing" style="max-height: 350px; overflow: auto;">
                                <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-hover table-condensed">
                                                        <caption class="text-center">考试信息</caption>
                                                        <thead>
                                                            <tr>
                                                                <th>考生编号</th>
                                                                <th>考试名称</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${ examApplyList}" var="apply">
                                                                <tr>
                                                                        <td>${apply.examNum }</td>
                                                                        <td>${apply.examName }</td>
                                                                        <td>${apply.siteName }</td>
                                                                        <td>${apply.majorName }</td>
                                                                        <td>
                                                                            <fmt:formatDate value="${apply.time }" pattern="yyyy-MM-dd"/>
                                                                        </td>
                                                                        <td>${apply.examRoom }</td>
                                                                        <td>${apply.sitNum }</td>
                                                                </tr> 
                                                             </c:forEach>
                                                        </tbody>
                                                            ...
                                                            <c:forEach items="${examSiteList }" var="examSite">
                                                                <tr>
                                                                    <c:forEach items="${examList }" var="exam">
                                                                        <c:if test="${examSite.examId == exam.examId }">
                                                                            <c:forEach items="${majorList }" var="major">
                                                                                <c:if test="${exam.majorId== major.majorId }">
                                                                    ...
                                                                    <c:forEach items="${siteList }" var="site">
                                                                        <c:if test="${examSite.siteId == site.siteId }">
                                                                            <td>${site.siteName }</td>
                                                                        </c:if>
                                                                    </c:forEach>
                                                                    <td>
                                                                        <a type="button" href="<%=path %>/student/applyExam?siteId=${examSite.siteId}&examId=${examSite.examId}" name="" class="btn btn-primary" style="padding:0px 33px;">报名</a>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
    ...
    <script type="text/javascript" src="<%=path %>/js/exam-apply.js"></script>
