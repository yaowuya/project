                            ...
                            <div class="row-fluid r-down-footing">
                                <div class="col-md-12">
                                    ...
                                    <div class="start-exampoint">
                                        <form class="form-horizontal" action="<%=path %>/exam/turnToExam" method="post" role="form">
                                            <div class="form-group">
                                                <div class="col-sm-8">
                                                    <input type="text" name="key" class="form-control" id="inputvalue" placeholder="输入考试ID、考试名称等多种查询条件">
                                                </div>
                                                <div class="col-sm-4">
                                                ...
                                                <div class="page-btn text-center">
                                                    <ul class="pagination"> 
                                                        <c:forEach begin="1" end="${page.total }" var="p">
                                                        	<c:if test="${pageNum == p }">
                                                        		<li class="active">
                                                        			<a href="<%=path%>/exam/turnToExam?pageNum=${p}&key=${key}">${p }</a>
                                                        		</li>
                                                        	</c:if>
                                                            <c:if test="${pageNum != p }">
                                                        		<li>
