...
<body>
            ...
            <div class="col-md-8 mid-right">
                ...
                <div class="row-fluid mid-right-down">
                    <div class="col-md-12 mid-r-down">
                           <form action="score/certificate" method="post">
                           <p class="cdl2">请输入查询条件：</p>
                                <input class="input-medium search-query cdl2" type="text" name="studentId"/> <button class="btn" type="submit">查找</button>
                                <button type="submit" class="btn cdl2">打印</button>
                            
                            
                            <div>
                                
                                <div class="col-md-5 biaoge1">
                                    <h2 align="center">统考合格证书</h2>
                                    <img src="images/头像.png" alt="照片" width="150px" height="150px">
                                    <ul>
                                        <li>姓名：${stuName}</li>
                                        <li>考点：</li>
                                        <li>学号：${studentId}</li>
                                        <li>统考分数：${examGrade}</li>
                                    </ul>
                                </div>
                                <div class="col-md-2"></div>
                                <div class="col-md-5 biaoge1">
                                    <h2 align="center">毕业论文合格证</h2>
                                    <img src="images/头像.png" alt="照片" width="150px" height="150px">
                                    <ul>
                                        <li>姓名：${stuName}</li>
                                        <!-- <li>院校：</li> -->
    ...
    <script type="text/javascript" src="js/hegezheng.js"></script>
</body>
