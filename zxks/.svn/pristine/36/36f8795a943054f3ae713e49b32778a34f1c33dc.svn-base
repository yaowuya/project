                            ...
                            <div class="row-fluid r-down-footing">
                                <div class="col-md-12">
                                    <div class="start-exampoint">
                                        <form class="form-horizontal" action="<%=path %>/site/updateSite" role="form" method="post" id="exampoint-add-xiugai">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-hover table-condensed">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" name="siteId" value="${site.siteId }" style="width: 100px" readonly>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="siteName" value="${site.siteName }" style="width: 100px" id="exampoint-add-xiugai-1" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="siteAddress" value="${site.siteAddress }" style="width: 100px" id="exampoint-add-xiugai-2" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="siteRoomNumber" value="${site.siteRoomNumber }" style="width: 100px" id="exampoint-add-xiugai-3" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="siteLinkman" value="${site.siteLinkman }" style="width: 100px" id="exampoint-add-xiugai-4" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="siteLinkphone" value="${site.siteLinkphone }" style="width: 100px" id="exampoint-add-xiugai-5" required>
                                                                </td>
                                                                <td>
